...
const HomePage = () => {
  return (
    <div className="bg-black min-h-screen flex flex-col items-center text-center font-Inter">
      <div className="mt-16">
        <h2 className="font-bold text-white text-3xl md:text-5xl lg:text-4xl">
            <span> India's largest{" "}
            <span className="text-yellow-400">digitally connected</span></span>
            <br></br>
           mobility
          and highway wayside amenities platform.
        </h2>
      </div>
